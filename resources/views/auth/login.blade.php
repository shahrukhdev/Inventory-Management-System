                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="{{ route('home') }}" class="brand-logo">
                                ...
                                <h2 class="brand-text text-primary ms-1">Inventory</h2>
                            </a>

                            <h4 class="card-title mb-1">Sign In to continue</h4>
                            ...
                            <form class="auth-login-form mt-2 p-1" method="POST" action="{{ route('login') }}">
                                @csrf
                                <div class="mb-1">
                                    <label class="form-label" for="login-email">Email</label>
                                    <input class="form-control" id="login-email" type="text" name="email" value="{{ old('email') }}" required placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                </div>
                                <div class="mb-1">
