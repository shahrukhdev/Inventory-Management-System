                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        <div class="d-flex align-items-center justify-content-md-end mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                ...
                                                <input type="text" class="form-control invoice-edit-input"
                                                       placeholder="12345" name="invoice_no" required/>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <input type="date"
                                                   ...
                                                   value="{{ \Illuminate\Support\Carbon::now()->setTimezone('GMT+5')->toDateString() }}"
                                                   name="date" required/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row row-bill-to invoice-spacing">
                                    <div class="col-xl-8 mb-lg-1 col-bill-to ps-0">
                                        ...
                                        <div class="invoice-customer">
                                            <select
                                                class="invoiceto form-select @error('vendor_id') is-invalid @enderror"
                                            ...
                                            <div class="row">
                                                <div
                                                    ...
                                                    <div class="row w-100 pe-lg-0 pe-1 py-2 product_div">
                                                                ...
                                                                @if($products->count())
                                                                    @foreach ($products as $product)
                                                                        <option value="{{ $product->id }}"
                                                                                ...
                                                                                data-price="{{ $product->price }}">{{ $product->title }}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                        ...
                                                        <div
                                                            class="col-lg-3 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2 variation_div d-none"
                                                        ...
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2 price_div">
                                                            ...
                                                            <input type="number" class="form-control product_price"
                                                                   value="" placeholder="Price" name="product_price"
                                                                   data-rate required/>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        justify-content-between border-start WQinvoice-product-actions
                                                         py-50 px-25">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                        <div class="invoice-total-wrapper">
                                            <div class="invoice-total-item">
                                                ...
                                                <p class="invoice-total-amount">PKR <b class="wqSubTotal">0</b></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
